...
%% Challenge 3 
% You saw how to calculate the mean defense power for different
% dimensions
% Now create a 2D array containing the hit points, special attack and
% speed of each pokemon. Find the which power is maximum for each pokemon. 
